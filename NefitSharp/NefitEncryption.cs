...
namespace NefitSharp
{
    ...
    {
        private byte[] chat = new byte[] { 0x58, 0xf1, 0x8d, 0x70, 0xf6, 0x67, 0xc9, 0xc7, 0x9e, 0xf7, 0xde, 0x43, 0x5b, 0xf0, 0xf9, 0xb1, 0x55, 0x3b, 0xbb, 0x6e, 0x61, 0x81, 0x62, 0x12, 0xab, 0x80, 0xe5, 0xb0, 0xd3, 0x51, 0xfb, 0xb1 };
        private byte[] email = new byte[] { 0x52, 0xea, 0xfb, 0x7a, 0x84, 0xe9, 0x5c, 0x1d, 0xbd, 0xb0, 0xff, 0xef, 0x1a, 0xa5, 0xc8, 0xd1, 0xaa, 0xb8, 0x15, 0x8b, 0x52, 0x32, 0x93, 0x4f, 0x15, 0x4a, 0x7c, 0xff, 0xee, 0x29, 0xb9, 0x23 };
        private byte[] alarm = new byte[] { 0xb7, 0x69, 0x18, 0x67, 0x79, 0x9c, 0x11, 0xd5, 0xb8, 0x37, 0xf8, 0xa5, 0xe8, 0x6e, 0x81, 0xc8, 0xe6, 0xd2, 0xbb, 0xcc, 0x62, 0x4f, 0x15, 0x7a, 0xc4, 0xf0, 0x3d, 0x5d, 0x37, 0x01, 0xe1, 0x1e };
        ...
        public NefitEncryption(string serial, string access, string password)
        {
            ...
            _chatKey = GenerateKey(chat, access, password);
            _emailKey = GenerateKey(email, serial, "gservice_smtp");
            _alarmKey = GenerateKey(alarm, serial, "gservice_alarm");
        }
